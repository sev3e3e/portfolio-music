@props(['routename' => 'songs.store', 'method' => 'POST', 'song' => null, 'creators' => []])
...
<div class="fixed inset-0 z-10 overflow-y-auto">
    <div id="modalpanel" class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0"
        ...
        data-transition-enter-end="opacity-100 translate-y-0 sm:scale-100" data-transition-leave="ease-in duration-200"
        ...
        <div
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <div class="mt-4 ">
                    <form action="{{ route($routename) }}" method="{{ $method }}" enctype="multipart/form-data"
                        ...
                        <div>
                            ...
                            <x-text-input id="songName" class="block mt-1 w-full" type="text" name="songName"
                                required autofocus :value="(old('songName') ? old('songName') : isset($song)) ? $song->name : ''" />
                        ...
                        <div>
                            ...
                            <x-text-input id="songCreator" name="creator" list="creators" autocomplete="on"
                                class="block mt-1 w-full" type="search" required :value="(old('songCreator')
                                        ? old('songCreator')
                                        : isset($song))
                        ...
                        <div>
                            ...
                            <x-text-input id="songDesc" class="block mt-1 w-full" type="text" name="songDesc"
                                :value="(old('songDesc') ? old('songDesc') : isset($song)) ? $song->description : ''" required />
                        ...
                        <div>
                            ...
                            <x-text-input accept="audio/mp3" id="songAudio" class="block mt-1 w-full" type="file"
                                name="songAudio" required :value="(old('songAudio') ? old('songAudio') : isset($song)) ? $song->audioSrc : ''" />
                        ...
                        <div>
                            ...
                            <x-text-input accept="video/mp4" id="songMedia" class="block mt-1 w-full" type="file"
                                name="songMedia" :value="(old('songMedia') ? old('songMedia') : isset($song)) ? $song->movieSrc : ''" required autofocus />
