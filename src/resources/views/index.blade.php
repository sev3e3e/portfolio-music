    ...
    <body>
        <div id="background"
            ...
            <div
                ...
                <div class="w-full  flex items-center justify-center gap-4 py-16 sm:py-4">
                    ...
                    <input id="volume" type="range" value=0 min="0" max="100"
                        class="w-full max-w-[200px] h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700">
                </div>
