...
<x-app-layout>
    ...
    <body>
        <div id="background"
            class="flex flex-col max-h-[calc(100vh_-_10rem)] min-h-[calc(100vh_-_10rem)] w-full place-content-center  place-items-center text-white justify-center items-center">
